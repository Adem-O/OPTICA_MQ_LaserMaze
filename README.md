...
The UI is run on the controller's Raspberry Pi with the `LaserMazeController.py`. The schematic for the controller and Pi is found in `LaserMazeControllerSchematic.pdf`.
